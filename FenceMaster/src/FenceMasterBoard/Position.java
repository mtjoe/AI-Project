...
public class Position {
	...
	// Relating to the main Board
	private Board b;
	private int n;

	// To signify the coordinates of this Position on the board
	private int x, y;

	// Player that is in this board, null if empty
	private Player owner;

	// isEdge is true if this position is located on the Edge of the Board, and
	...
	// If isEdge, the direction of the edge in the board 
	 ...
	 *         (i.e. withing the board), false otherwise
	 */
